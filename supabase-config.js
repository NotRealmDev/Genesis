...
window.GENESIS_VM = {
  ...
  displayMode: "embed",
  build: "host-webrtc-r7"
};

(function loadGenesisAdminVm(){
  const BUILD = "host-webrtc-r7";
  let loading=false;
  let ready=false;
  ...
  async function load(){
    ...
    try{
      ...
      if(!window.GenesisVM)await addFreshScript("genesis-vm.js","genesis-vm-host-r7");
      installHostGuard();
      await addFreshScript("genesis-host-vm.js","genesis-host-vm-host-r7");
